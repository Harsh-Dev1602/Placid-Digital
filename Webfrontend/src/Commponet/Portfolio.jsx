      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-20">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 tracking-tight">
            Explore Our <span className="text-[#164676]">Popular Projects</span>
          </h1>
            ...
            >
              ...
              <div className="relative overflow-hidden p-4 pb-0">
                ...
                <div className="absolute top-8 left-8">
                  <span className="bg-[#164676] text-white text-[10px] uppercase tracking-widest font-black px-3 py-1 rounded-lg">
                    Live Case
                  </span>
                </div>
              </div>
              ...
              <div className="p-8 flex flex-col flex-grow">
                <div className="mb-4">
                    <h3 className="text-2xl font-bold text-gray-800 group-hover:text-[#164676] transition-colors duration-300">
                    {item.portfolisName}
                    </h3>
                </div>
                ...
                <div className="mt-auto pt-4 border-t border-gray-50 flex items-center justify-between">
                  ...
                  <button className="text-[#164676] group-hover:bg-[#164676] group-hover:text-white p-3 rounded-full transition-all duration-300 border border-green-50">
