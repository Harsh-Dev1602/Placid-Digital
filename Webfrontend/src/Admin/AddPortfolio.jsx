      ...
      <div style={{ height: "calc(100vh - 40px)" }} className="w-full flex justify-center items-center">
        <StyledWrapper>
          <form onSubmit={handleSubmit(onSubmit)} className=" w-2xl mx-auto space-y-4 p-5 relative shadow-lg">
            <h1 className='text-4xl font-bold  text-center text-[#154979d0]'>Add Portfolio</h1>
            ...
            <div className="w-full">
              <label className="custum-file-upload">
                ...
                <div className="text">
                  <span className='text-center'>Click to upload portfolio image</span>
                </div>
                <input id="file" type="file" onChange={handleFileChange} />
              </label>
              {errors.portfolisImgUrl && <span className=' text-red-600 mt-5'>This field is required</span>}
