...
function PortfolioManager() {
  ...
  const handleDelete = async (id) => {
    ...
    if (!ok) return
    try {
      await axios.delete(`/sfs-app/admin/portfolio-delete/${id}`)
  ...
  return (
    <div className="p-6">
      ...
      <h2 className="text-2xl font-semibold pl-5 mb-4">Portfolio Items</h2>       
        <Link to="/admin-dashboard/add-portfolio" className='hidden lg:block bg-[#154979] text-white text-base  hover:bg-transparent duration-300 hover:text-[#154979] border border-[#154979] px-6 py-2 rounded-lg font-semibold hover:cursor-pointer'>
            Add Portfolio
        </Link>
      </div>
